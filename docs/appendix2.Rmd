...
```{r refplot, fig.height = 8, fig.width = 7, fig.cap = 'Figure 1: Number of stream miles for the estimated discharge (< 1 cfs, 1 - 10 cfs, 10 - 100 cfs, > 100 cfs) under reference conditions. Discharges were also estimated for different climate scenarios for years that were dry, normal, or wet.'}
